  ...
  try {
    ...
    if (existingSettings.length === 0) {
      await connection.query(`INSERT INTO website_settings
        ...
        "BODALS INTERNATIONAL",
        'Your trusted Indian Exporter connecting global buyers with premium seafood (Shrimp Exporter), Textiles Exporter, Agricultural Products Exporter (Onion Exporter, Indian Fruits Exporter, Rice Exporter, Indian Pulses Exporter, Spices), and Indian Coffee Exporter.',
        `At BODALS INTERNATIONAL, we are a dynamic and forward-thinking Indian Exporter and premium merchant export house dedicated to bringing the finest Indian agricultural products, textiles, and seafood to the global market. Rooted in India's rich agricultural and manufacturing heritage, our mission is to serve as a reliable bridge between authentic Indian producers and international buyers who demand excellence.\n\nWhile our approach is modern and globally minded, our core values are built on traditional principles of trust, transparency, and unwavering commitment to quality. We have assembled a highly skilled team with deep industry knowledge, robust sourcing capabilities, and a meticulous understanding of global supply chain logistics.\n\nWhether you are looking for a reliable Agricultural Products Exporter (onion, fruits, grains, pulses), Seafood Exporter (Shrimp Exporter), Textiles Exporter, Indian Spices Exporter, or Indian Coffee Exporter, we are equipped with the resources, agility, and expertise to deliver unparalleled value. We don't just export products; we build long-term, mutually beneficial partnerships across borders.`,
        ...
        `Our purpose is to bridge the distance between India's rich resources and the global demand for quality through a promise-led business model. We exist to simplify international trade, providing a seamless and reliable path for premium Indian Shrimps, Textiles, and Agricultural products to reach every corner of the world. At Bodals, we don't just move goods; we build the infrastructure of global trust.`,
        '+91 9082377097',
        'manishbodal@bodalsint.com',
        'Mumbai, Maharashtra, India',
        "Premium Indian Exporter & Merchant Export House — connecting authentic producers with international buyers."
      ]);
    ...
    if (existingProducts[0].c === 0) {
      const products = [
        ['High-Quality Seafood (Seafood Exporter & Shrimp Exporter)', 'Seafood', 'Premium IQF shrimp from Konkan & Andhra coasts.', 'Sourced from pristine waters and processed in state-of-the-art, certified facilities, we provide fresh and frozen seafood that guarantees exceptional taste, texture, and safety. Specialised in Shrimp (IQF) directly sourced from Konkan and Andhra Coast as a trusted Seafood Exporter and Shrimp Exporter.', '["IQF Certified", "MPEDA Approved", "Pristine Sourcing"]'],
        ['Premium Textiles (Textiles Exporter)', 'Textiles', 'Indian silk, fabrics & contemporary weaves.', "Drawing from India's legacy of fabric craftsmanship, we supply premium textiles, fabrics, and premium Indian silk as a premier Textiles Exporter, ensuring excellent thread counts, durability, and contemporary appeal for the global fashion and manufacturing industries.", '["Heritage Craft", "Export Quality", "Custom Weaves"]'],
        ['Agricultural Products Exporter (Onions, Fruits & Veggies)', 'Fresh Agricultural', 'Farm-fresh onions, potatoes, fruits & vegetables.', 'As a leading Agricultural Products Exporter, we source farm-fresh, nutrient-rich produce directly from trusted growers. Our key offerings include premium onions (Onion Exporter), potatoes, seasonal vegetables, and vibrant, export-quality fruits (Indian Fruits Exporter).', '["Farm Direct", "Nutrient-Rich", "Seasonal Range"]'],
        ['Cereals & Grains (Rice Exporter & Pulses Exporter)', 'Cereals & Grains', 'Carefully processed, food-safe Indian grains.', "India is the world's breadbasket, and we export high-quality, carefully processed cereals and grains. We are a trusted Rice Exporter and Indian Pulses Exporter, supplying premium grains that meet the highest standards of food safety and nutritional value.", '["Food Safety", "Bulk Supply", "Global Standards"]'],
        ['Premium Coffee & Spices (Indian Coffee Exporter & Spices Exporter)', 'Premium Indian Coffee', "Robusta Cherry AA and premium spices from India's finest estates.", "Harvested from India's finest estates, our exports offer rich aromas and distinct flavor profiles. We are a leading Indian Coffee Exporter (supplying Robusta Cherry AA) and Indian Spices Exporter, catering to the discerning tastes of global buyers.", '["Estate Sourced", "Robusta AA & Spices", "Distinct Aroma"]']
      ];
