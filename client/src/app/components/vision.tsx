      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-20 max-w-3xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}
            className="inline-block px-3 py-1 rounded-full border border-[#d4af37]/40 text-[#d4af37] text-xs tracking-[0.2em] uppercase mb-4">Philosophy</motion.div>
          <motion.h2 initial={{ opacity: 0, y: 25 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.1 }}
            className="tracking-tight" style={{ fontFamily: "Playfair Display, serif", fontSize: "clamp(2rem, 4vw, 3.5rem)", fontWeight: 700 }}>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          {[
            ...
            <motion.div key={i}
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8, delay: i * 0.15, type: "spring", stiffness: 100, damping: 18 }}
              className="p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur hover:border-[#d4af37]/40 transition">
              <motion.div initial={{ scale: 0 }} whileInView={{ scale: 1 }} viewport={{ once: true }} transition={{ type: "spring", stiffness: 300, damping: 15, delay: 0.3 + i * 0.15 }}
                className="w-12 h-12 rounded-lg bg-[#d4af37]/15 text-[#d4af37] flex items-center justify-center mb-5">
        ...
        {/* Core values */}
        <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.7 }} className="text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-white/70" style={{ fontFamily: "Inter" }}>
            ...
            <motion.span initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.3 }}
              className="block mt-2 text-white" style={{ fontFamily: "Playfair Display, serif", fontSize: "1.35rem" }}>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {values.map((v, i) => (
            <motion.div key={i}
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6, delay: 0.15 + i * 0.15, type: "spring", stiffness: 150, damping: 18 }}
              whileHover={{ y: -8 }}
              className="relative p-8 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/10 hover:border-[#d4af37]/50 group overflow-hidden">
              ...
              <div className="relative">
                <motion.div initial={{ scale: 0, rotate: -20 }} whileInView={{ scale: 1, rotate: 0 }} viewport={{ once: true }} transition={{ type: "spring", stiffness: 300, damping: 15, delay: 0.35 + i * 0.15 }}
                  className="w-14 h-14 rounded-xl bg-[#d4af37] text-[#0a1628] flex items-center justify-center mb-5">
